_load shell/zsh/plugins/powerlevel10k/powerlevel10k.zsh-theme || return 1
# Generated by Powerlevel10k configuration wizard on 2021-07-11 at 04:14 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # taskwarrior           # taskwarrior task count (https://taskwarrior.org/) # EDIT: disable
    # time                  # current time
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=6 # EDIT: green -> cyan
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=1
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='❯'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='▢' # EDIT: ❮ -> ▢
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=3 # EDIT: blue -> yellow
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=3 # EDIT: blue -> yellow
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=3 # EDIT: blue -> yellow
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=same-dir # EDIT: always -> same-dir
