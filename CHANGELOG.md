...
* **bspwm:** use correct class for google-chrome rule ([af2d3f7](https://github.com/eliasnorrby/dotfiles/commit/af2d3f7ff6548925ea06b67cb786fb03e2117e7d))
* **polybar:** ensure integer in task urgency comparison ([9c2751b](https://github.com/eliasnorrby/dotfiles/commit/9c2751bffc6b99407baaac73432dc07b72337317))
* **tmux:** catch error in go_to_next_alert.sh ([780f788](https://github.com/eliasnorrby/dotfiles/commit/780f7883d7869a18a9fefc981c2775017c7aebaf))
* **vim:** fix shellcheck not running ([d106e2d](https://github.com/eliasnorrby/dotfiles/commit/d106e2d93070aa1dc260fb25b9cf16c5b425dc16))
* **zsh:** fix find option order in p ([db13507](https://github.com/eliasnorrby/dotfiles/commit/db13507fe66c7b757e88668737ccad5554f4ea01))
* **zsh:** only remove space if expanding ([df1de08](https://github.com/eliasnorrby/dotfiles/commit/df1de081aa4c1d76ffcf2da49e9300e7a5cbb37c))
* **zsh:** switch to using copy_cmd ([942478c](https://github.com/eliasnorrby/dotfiles/commit/942478c7a887502addf09bf50ce04f4a80ad48a5))


### Features

* **alacritty:** enable cursor blinking ([e4fd487](https://github.com/eliasnorrby/dotfiles/commit/e4fd48771cdce32d91ea822675f47a3abfe891de))
* **arch:** launch udiskie on startup ([4f7e673](https://github.com/eliasnorrby/dotfiles/commit/4f7e67338ebf911fe99a0bac9dc03209a65dbc26))
* **arch:** switch from chromium to google-chrome ([88d218d](https://github.com/eliasnorrby/dotfiles/commit/88d218d44c8980df088e9f127f1db3b7c0d9c9b4))
* **bspwm:** restructure desktops ([e995f7a](https://github.com/eliasnorrby/dotfiles/commit/e995f7a6b02fb0f509797baca0cea7d267cf3448))
* **feh:** allow a default wallpaper ([9b2148f](https://github.com/eliasnorrby/dotfiles/commit/9b2148fc1e66f79ca79d2e9438aaf1e038e4d122))
* **git:** add alias for fuzzy finding aliases ([5013bc9](https://github.com/eliasnorrby/dotfiles/commit/5013bc9d5ce8fc48f7c7cce13fbaf2c594766ca4))
* **kubernetes:** add alias for context switching ([b06332f](https://github.com/eliasnorrby/dotfiles/commit/b06332f8d4ecf8bb7cfd5bf64e2f54681b2483c3))
* **kubernetes:** add aliases for (un-)setting namespace ([3eb38f3](https://github.com/eliasnorrby/dotfiles/commit/3eb38f3e16c52b49f1991b952fc69fc0cb5a9029))
* **kubernetes:** add k9s palenight skin ([f27b216](https://github.com/eliasnorrby/dotfiles/commit/f27b216e4f9723ba7194640509e22eab42061c49))
* **kubernetes:** add token update scripts ([31cd84f](https://github.com/eliasnorrby/dotfiles/commit/31cd84ffecc787ca4a408505dd007ec952cc6e2f))
* **picom:** make taskwarrior-tui transparent ([cd3ae96](https://github.com/eliasnorrby/dotfiles/commit/cd3ae9637fcefb90c1d54d40b11aeb323aa679e0))
* **polybar:** add secondary-stats bar ([ac545c3](https://github.com/eliasnorrby/dotfiles/commit/ac545c3be053197fff6b65bc698036567e13bd1f))
* **polybar:** add task module ([a95e244](https://github.com/eliasnorrby/dotfiles/commit/a95e2443aadc4ea79c385740a3d2a70f6518566a))
* **polybar:** control spotify on click ([d77a638](https://github.com/eliasnorrby/dotfiles/commit/d77a6381d2aebd14672d8c07f7d84c8738ea72a2))
* **polybar:** hide empty bspwm desktops ([a2da8c7](https://github.com/eliasnorrby/dotfiles/commit/a2da8c7e4cc56ce33c1f1b88164af53f6f459636))
* **polybar:** style github module ([3954485](https://github.com/eliasnorrby/dotfiles/commit/3954485abaec01649a4ff308aab6e63b640b6c00))
* **polybar:** use dot for generic desktops ([fc122b6](https://github.com/eliasnorrby/dotfiles/commit/fc122b6e3b7d984db61f1799a6e1f3733199aa5a))
* **polybar:** use icons as desktop labels ([a955bc3](https://github.com/eliasnorrby/dotfiles/commit/a955bc338851343fdd23479bdb33026386ddfd31))
* **sxhkd:** add arrow key hyper bindings ([f300c33](https://github.com/eliasnorrby/dotfiles/commit/f300c3384dc1cb2d691f969736728ad6dd464a45))
* **sxhkd:** add modifiers to arrow key bindings ([4743ca4](https://github.com/eliasnorrby/dotfiles/commit/4743ca4e8bc9bb23deba35ea95c84845be8af763))
* **sxhkd:** update focus bindings ([91c7e2f](https://github.com/eliasnorrby/dotfiles/commit/91c7e2f3ddd7cfc210334ff66bf955932a47594c))
* **task:** add dedicated window for taskwarrior-tui ([b06f5d1](https://github.com/eliasnorrby/dotfiles/commit/b06f5d13a98a36db62032cce6595815472922131))
* **task:** add standup aliases ([ff172f6](https://github.com/eliasnorrby/dotfiles/commit/ff172f69a8f9d720d338e17be613a71a5734fadb))
* **task:** add task polybar module ([f4c1f77](https://github.com/eliasnorrby/dotfiles/commit/f4c1f77b2b798eb6f3666ea2c0035430c77ca2c6))
* **task:** add taskrc ([37b0dae](https://github.com/eliasnorrby/dotfiles/commit/37b0daec45a4acecc56f53154391fd062751a207))
* **task:** add topic config ([97809e3](https://github.com/eliasnorrby/dotfiles/commit/97809e3dfa0bc828b87e23949f77b5c312bedb17))
* **tmux:** add argocd context to tools_element ([9222b47](https://github.com/eliasnorrby/dotfiles/commit/9222b47f8fe43a4018e114dd971ccd3dab781ef1))
* **tmux:** add k8s namespace to tools_element ([e97a221](https://github.com/eliasnorrby/dotfiles/commit/e97a2217e9758093170ecace4bda3f5a7e7b9f67))
* **tmux:** add tools status element ([eb36019](https://github.com/eliasnorrby/dotfiles/commit/eb360196181b9c141515d45ecf469e4d9936025f))
* **tmux:** bind n to go to next window with alert ([229b887](https://github.com/eliasnorrby/dotfiles/commit/229b887de06886b84ee99979495b225ddd85e250))
* **tmux:** show alert indicator in session list ([fdecd86](https://github.com/eliasnorrby/dotfiles/commit/fdecd86701f8291943a3e15dd927548e9b5cf7e2))
* **tmux:** style windows with bells ([715484f](https://github.com/eliasnorrby/dotfiles/commit/715484fb0722e06e0d9d60e3900dd72da446d7a6))
* **tmux:** use ? as context fallback in tools_element ([0b0ab13](https://github.com/eliasnorrby/dotfiles/commit/0b0ab139334a4237df0ef3a9cb165c85e765378b))
* **vim:** add coc-git ([668e0b2](https://github.com/eliasnorrby/dotfiles/commit/668e0b2918d040dd04e3d2a54a20d8e76afeb3ba)), closes [neoclide/coc-git#185](https://github.com/neoclide/coc-git/issues/185)
* **vim:** add conventional commit snippets ([e37a843](https://github.com/eliasnorrby/dotfiles/commit/e37a84346e4a8b5b2549250547689f773b01de79))
* **vim:** add fzf-checkout ([fd3a72e](https://github.com/eliasnorrby/dotfiles/commit/fd3a72e44f4b5b84fc78e79a085b0cba60372304))
* **vim:** set inccommand=split and cursorline ([078f36f](https://github.com/eliasnorrby/dotfiles/commit/078f36fc854be627b35077c90c28114193dff2e6))
* **work:** add teams ([4897cc5](https://github.com/eliasnorrby/dotfiles/commit/4897cc5aeb3b87de659b4e3e03bdffd7ba655f0f))
* **zsh:** add (un)backup utilities ([9f40221](https://github.com/eliasnorrby/dotfiles/commit/9f40221424c68832285cf69c689c125bd86a62f2))
* **zsh:** add cdt alias ([4b0cde2](https://github.com/eliasnorrby/dotfiles/commit/4b0cde215af0fc18aaca4916451ba519e5f9bcc9))
* **zsh:** add entr aliases ([ecb8cae](https://github.com/eliasnorrby/dotfiles/commit/ecb8caed2fbca42c4c28db4a33ff12d8a406158b))
* **zsh:** add H global alias ([18d6f08](https://github.com/eliasnorrby/dotfiles/commit/18d6f082824389397efa2f02c6cd80a44edbfd90))
* **zsh:** add notify_me with global alias ([6f11b11](https://github.com/eliasnorrby/dotfiles/commit/6f11b11053d5011cf35fc40d007c97d2edc4b141))
* **zsh:** auto-expand aliases ([530e349](https://github.com/eliasnorrby/dotfiles/commit/530e3490eac937ca72a4108b2c2ee6d5e01438c2))
